...
//                    Bundle bundle= ActivityOptions.makeSceneTransitionAnimation(ArticleListActivity.this,vh.thumbnailView,vh.thumbnailView.getTransitionName()).toBundle();
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            loader.get((mCursor.getString(ArticleLoader.Query.THUMB_URL)), new ImageLoader.ImageListener() {
                @Override
                    ...
                    if (bitmap != null) {
                        Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
                            ...
                            public void onGenerated(@Nullable Palette palette) {
                                mMutedColor = palette.getDarkMutedColor(0xFFa76bcf);
